...
var serialpath='/tmp/tokentest/serialup'+new Date().getTime()+'.json';
var t='kjbklbwefibwfe';
var newt='wefgwrrwgw';
var oldserial=new sysId(serialpath);
oldserial.validated=true;
oldserial.token=t;
outputFileSync(serialpath, JSON.stringify(oldserial), 'utf-8');
oldserial.update(oldserial.serial,t,newt);
